...
import { MagnifyingGlassIcon, UserIcon, BookmarkIcon, ShoppingBagIcon } from '@heroicons/react/24/Outline';


export default function Header() {
  return (
    <div className="bg-gray-100 flex flex-col items-center select-none sm:flex-row justify-between px-8 border-b border-gray-800 hover:bg-gray-50 hover:border-none">
      <div>
