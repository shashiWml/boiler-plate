    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-9">
        ...
        <div className="mx-96 w-full">
          ...
          <h1 className="font-bold  text-justify mx-auto  mt-5 text-lg">
            OVERVIEW
          </h1>
          <p className=" text-sm  mt-5 text-justify mx-auto ">
            This website is operated by New Brave Ventures Pvt. Ltd. Throughout the site, the terms “we”, “us” and “our” refer toNew Brave Ventures Pvt. Ltd. KOOVS offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
          </p>
          ...
          <p className="text-sm  mt-3 text-justify mx-auto">
            In no case shall New Brave Ventures Pvt. Ltd, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.
          </p>
          <h1 className="font-bold  text-justify mx-auto  mt-5 text-lg">
            SECTION 15 - INDEMNIFICATION
          </h1>
          <p className=" text-sm  mt-5 text-justify mx-auto">
            You agree to indemnify, defend and hold harmless New Brave Ventures Pvt. Ltd. and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
          </p>
          <h1 className="font-bold  text-justify mx-auto  mt-5 text-lg">
